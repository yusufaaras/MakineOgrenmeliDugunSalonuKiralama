            ...
            <div className="flex-grow-1">
              ...
              <form>
                ...
                <div className="mb-3">
                  ...
                  <select className="form-select" onChange={handleAlcoholChange}>
                ...
                <div className="mb-3">
                  ...
                  <select className="form-select" onChange={handleSnackChange}>
                ...
                <div className="mb-3">
                  ...
                  <select className="form-select" onChange={handleMealChange}>
