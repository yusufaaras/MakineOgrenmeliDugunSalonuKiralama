  ...
  return (
    ...
    >
      ...
      <div className="carousel-caption d-none d-lg-block">
        <h5>Hayalleriniz bir tık uzakta</h5>
        <p>Düğün salonu bulmak artık çok kolay.
          Hayalini kurduğunuz düğün salonunu size zahmet dahi vermeden bulmanıza yardımcı olacağız.
          Bunun garantisini veriyoruz </p>
      </div>
    </div>
  );
}
